# Execucao Local Obrigatoria

O caminho padrao deste repositorio e local/Docker. Nao use Vercel, Cloud Run ou Supabase Cloud como dependencia padrao.

Subida completa na raiz:
...
- Gateway Supabase-compatible local: `http://localhost:54321`

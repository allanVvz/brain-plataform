...
> Extraído de `memory.md`. Descreve a fase de 2026-08-12 em que Aurora estava
> pausada e só o WA Validator rodava. O próprio `memory.md` já avisava para não
> confiar nesta seção. Mantido como histórico de release.

...
all, on the assumption "Meta never uses the agentic engine" — that stopped
...
def test_main_preserves_a_complete_meta_n8n_agents_binding(monkeypatch):
    ...
    binding used to have zero preservation logic — the very next deploy
    ...
    # Preserved: no reset of channel/provider/n8n_workflow_id/metadata —

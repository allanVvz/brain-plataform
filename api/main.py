...
from routes import auth, health, process, insights, leads, messages, kb, personas, integrations, logs, knowledge, pipeline, kb_intake, generation, wa_validator, graph, graph_documents, graph_bundles, graph_projections, marketing, audiences, assets, menu, qa_contract, public_site_formats, whatsapp, conversations, access, portal, evolution_webhook, messaging_campaigns, agent_harness, agents
...
app.include_router(whatsapp.internal_router)
...
app.include_router(messages.internal_router)
...
app.include_router(graph_bundles.router)
app.include_router(graph_projections.router)
app.include_router(marketing.router)
app.include_router(audiences.router)
app.include_router(messaging_campaigns.router)
app.include_router(agent_harness.router)
app.include_router(assets.router)
app.include_router(menu.router)
app.include_router(public_site_formats.router)

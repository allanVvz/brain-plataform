      ...
      {!data && !error ? (
        ...
        <>
          ...
          <div className="relative">
            <section className="portal-scroll-x flex snap-x gap-4 overflow-x-auto pb-3">
            ...
            <div
              aria-hidden="true"
              className="pointer-events-none absolute inset-y-0 right-0 w-10 bg-gradient-to-l from-[#f4f6fa] to-transparent"
            />
          </div>
        </>
      )}
